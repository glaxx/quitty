...
% 
% Angepasst fuer quitty <TODO: insert quitty URL> 
% Stefan Luecke (glaxx), <glaxx@glaxx.net>
...
\begin{document}
\MyFormBox[0.0cm]{Aussteller (Bezeichnung und Anschrift der steuerbegünstigten Einrichtung)}{<<.Issuer>>}
...
\MyFormBox[0.0cm]{Name und Anschrift des Zuwendenden}{<<.Recipient>>}
